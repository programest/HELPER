...
//oninput="Patterns(this.value, this) "
//phone это value элемента
// block это для чего нужно добавить pattern
//MAX_PHONE_LENGTH максимум символов
...
function Patterns(phone, block) {
	...
	if (phone.length >= 1) {
	  ...
	  if (countryCode === '+7' || countryCode === '7' || countryCode === '8') {
		// Russia
